...
- [5. Application Domain Crates](app_crates.md)
    ...
    - [odin_openmeteo](odin_openmeteo/odin_openmeteo.md)
...
- [6. ODIN Example Applications](examples.md)
    ...
    - [odin_live_aus](odin_live_aus/odin_live_aus.md)

- [7. ODIN Tool Crates](tool-crates.md)
    - [mkslides](mkslides/mkslides.md)
