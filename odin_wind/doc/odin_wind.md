...
Weather forecasts in the CONUS normally uses [NOAA HRRR](https://rapidrefresh.noaa.gov/hrrr/) but `odin_wind` abstracts
the concrete weather service by means of the [`odin_wx::WxService`](../odin_wx/odin_wx.md) trait. WindNinja loads the
weather forecast grids through [`GDAL`](https://gdal.org/en/stable/index.html) and only requires bands with meta data
...
The Weather data is periodically obtained through [`odin_wx::WxService`](../odin_wx/odin_wx.md) trait objects
(e.g. encapsulating [`odin_hrrr::HrrrActor`](../odin_hrrr/odin_hrrr.md) 
or [`odin_openmeteo::OpenMeteoActor`](../odin_openmeteo/odin_openmeteo.md) actors). WindNinja
